			...
			<div id="wrapper">
                <div class="left_64">
                    <?php for($i=0; $i< 16; $i++) { $item = $allmatches[$i];?>
                        <div class="match_64" id="<?php echo $i;?>" <?php ($i == 15) ? ' style="margin-bottom:0px;"': '' ?>>
                ...
                <div class="left_32">
                    <?php for($i=32; $i< 40; $i++) { $item = $allmatches[$i];?>
                        <div class="match_32" id="<?php echo $i;?>" <?php ($i == 39) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="left_16">
                    <?php for($i=48; $i< 52; $i++) { $item = $allmatches[$i];?>
                        <div class="match_16" id="<?php echo $i;?>" <?php ($i == 51) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="left_8">
                    ...
                    <?php for($i=56; $i< 58; $i++) { $item = $allmatches[$i];?>
                        <div class="match_8" id="<?php echo $i;?>" <?php ($i == 57) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="semi">
                    <?php for($i=60; $i< 62; $i++) { $item = $allmatches[$i];?>
                        <div class="match_4" id="<?php echo $i;?>" <?php ($i == 62) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="final">
                    <?php $i =62; $item = $allmatches[$i];?>
                        <div class="match_2" id="<?php echo $i;?>" <?php ($i == 62) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="right_8">
                    <?php for($i=58; $i< 60; $i++) { $item = $allmatches[$i];?>
                        <div class="match_8" id="<?php echo $i;?>" <?php ($i == 59) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="right_16">
                    <?php for($i=52; $i< 56; $i++) { $item = $allmatches[$i];?>
                        <div class="match_16" id="<?php echo $i;?>" <?php ($i == 55) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="right_32">
                    <?php for($i=40; $i< 48; $i++) { $item = $allmatches[$i];?>
                        <div class="match_32" id="<?php echo $i;?>" <?php ($i == 47) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
                                <div class="team"><?php echo $item->visitor;?></div>
                ...
                <div class="right_64">
                    <?php for($i=16; $i< 32; $i++) { $item = $allmatches[$i];?>
                        <div class="match_64" id="<?php echo $i;?>" <?php ($i == 31) ? ' style="margin-bottom:0px;"': '' ?>>
                            <div class="match_time_box"><?php echo $item->matchtime;?><span>#<?php echo $item->ps;?></span></div>
                            <div class="match_name_box">
                                <div class="team"><?php echo $item->home;?></div>
                                <div class="result"><?php echo $item->homeval;?></div>
