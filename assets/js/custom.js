...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2018/02/25 10:00').on('update.countdown', function(event) {
	  var $this = $(this).html(event.strftime(''
	    + '<span class="mu-event-counter-block"><span>%D</span> Dana</span> '
	    + '<span class="mu-event-counter-block"><span>%H</span> Sati</span> '
	    + '<span class="mu-event-counter-block"><span>%M</span> Minuta</span> '
	    + '<span class="mu-event-counter-block"><span>%S</span> Sekundi</span>'));
	});
